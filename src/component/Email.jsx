...
const Email = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Wait for a moment before reloading so user can see the alert
      setTimeout(() => {
  ...
  return (
    <>
      ...
      <section className="relative flex items-center justify-center min-h-screen bg-white px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24 overflow-hidden">
        {/* Alert */}
        {showAlert && (
        ...
        {/* Form + Image Wrapper */}
        <div className="relative z-10 w-full max-w-5xl flex flex-col lg:flex-row gap-8 bg-[#111827] p-6 sm:p-8 rounded-2xl border border-white/10 shadow-lg">

          {/* Contact Form */}
          <div className="w-full lg:w-1/2">
            <h2 className="text-white text-2xl sm:text-3xl font-bold mb-4">Transaction Receipt</h2>
            <p className="text-neutral-400 text-sm sm:text-base mb-8">
              For a transaction receipt, please fill out the form. It will be provided within 2 business days.
            </p>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center">
            <img
              ...
              className="rounded-2xl w-full h-full max-h-[500px]"
            />
          </div>
        </div>
      </section>
